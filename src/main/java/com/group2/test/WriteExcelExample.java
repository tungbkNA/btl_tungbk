...
import com.group2.ui.HSSFWorkbook;
import java.io.File;
...
public class WriteExcelExample {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String excelFilePath = "src/books.xlsx";
    ...
    public static void writeExcel(List<Book> books, String excelFilePath) throws IOException {
        ...
        // Create sheet
        Sheet sheet = workbook.getSheetAt(0); // Create sheet with sheet name
    ...
    private static List<Book> getBooks() {
        ...
        Book book;
        for (int i = 1; i <= 5; i++) {
            book = new Book(i, "Hieu" +i, i, i+2, i*1000);
            listBook.add(book);
        }
        return listBook;
    }

 ...
 * @author HieuHoang
 */
public class GioHangGTPanel extends javax.swing.JPanel {

    /**
     * Creates new form GioHangGTPanel
     */
    public GioHangGTPanel() {
        initComponents();
        setSLGoiTap();
    }
    ...
    public void setSLGoiTap() {
        cartModel1.getConBtn1().setText("" + GioHangGT.listGT.size());
    ...
    private void initComponents() {
        ...
        gradientBackGround1.setColorStart(new java.awt.Color(240, 240, 240));
